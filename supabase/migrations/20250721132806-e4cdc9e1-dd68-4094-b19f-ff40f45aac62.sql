-- Comprehensive Security Enhancement Migration (Schema Corrected)
-- Fix security definer functions and enhance encryption

-- 1. Create encryption keys table for secure key management
...
-- 2. Enhanced encryption audit table
...
-- 3. Enhanced profile data encryption
...
-- 4. Enhanced transaction data encryption  
...
-- 5. Create secure encryption function with proper AES-256
...
-- 6. Enhanced data access policies with encryption awareness
...
-- 7. Enhanced transaction policies with encryption requirements (using order_id relationship)
...
-- 8. Enhanced message policies for encrypted communication
...
-- 9. Create data classification table for compliance
...
('transactions', 'payment_method', 'restricted', true, ARRAY['PCI', 'Financial']),
...
-- 10. Create security compliance monitoring function
...
-- 11. Create indexes for performance and security
...
-- 12. Create security policy documentation table

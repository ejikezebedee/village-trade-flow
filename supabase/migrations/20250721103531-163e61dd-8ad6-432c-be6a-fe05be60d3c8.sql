...
-- Insert default languages with consistent column count
INSERT INTO public.languages (code, name, native_name, is_active, is_rtl) VALUES
  ...
  ('hr', 'Croatian', 'Hrvatski', true, false),
  ('sk', 'Slovak', 'Slovenčina', true, false),
  ('sl', 'Slovenian', 'Slovenščina', true, false),
  ('et', 'Estonian', 'Eesti', true, false),
  ('lv', 'Latvian', 'Latviešu', true, false),
  ('lt', 'Lithuanian', 'Lietuvių', true, false);

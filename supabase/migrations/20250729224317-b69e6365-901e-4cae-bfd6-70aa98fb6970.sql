...
-- 3. Enable RLS and create policies (with proper cleanup)
...
-- 6. Update is_admin function with proper search_path
...
-- 7. Create secure admin authentication function
...
-- 9. Force immediate password migration for existing admins
UPDATE public.admins 
